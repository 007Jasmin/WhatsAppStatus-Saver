...
class LanguageSelectionVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lblHeader.text = "Choose the Language".localized//.localizeString(string: langVal)
...
extension LanguageSelectionVC
{
    func SetSettingArray()
    {
        arrLanguage = [["name":"English","color":UIColor(hexString: "#1BD92E"),"code":"en"],
                       ["name":"France","color":UIColor(hexString: "#00A3FF"),"code":"fr"],
                       ["name":"Spanish","color":UIColor(hexString: "#FFA748"),"code":"es"],
                       ["name":"Dutch","color":UIColor(hexString: "#29BFA4"),"code":"nl"],
                       ["name":"Italian","color":UIColor(hexString: "#FF6969"),"code":"it"],
                       ["name":"Portugal","color":UIColor(hexString: "#C059FF"),"code":"pt"]
